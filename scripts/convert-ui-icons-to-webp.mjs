...
const iconsDir = join(repoRoot, 'src', 'assets', 'ui', 'icons');
...
function printHelp() {
  console.log(`Convert UI icon PNGs to WebP using cwebp.

Usage:
  npm run images:icons:webp -- [options]
...
function main() {
  ...
  const icons = findPngIcons();

  if (icons.length === 0) {
    console.log('No icon PNGs found.');
    return;
  }
